          ...
          <section className="bg-inherit h-4/5 flex justify-center items-center relative"  >
            <div className=" relative flex flex-col-reverse gap-10 md:grid max-w-screen-xl py-8 mx-auto  lg:gap-8 xl:gap-0 lg:py-16  lg:grid-cols-12">
              <div className="mr-auto place-self-center relative lg:col-span-7">
                ...
                <h1 className="relative max-w-2xl mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl bg-gradient-to-r from-[rgb(0,245,160)] to-[rgb(0,217,245)] bg-clip-text text-transparent " id='hero' >ARIF BASHA .H</h1>
                <p className="relative max-w-xl tracking-wider mb-6 font-light  lg:mb-8 md:text-md lg:text-md text-gray-300 me" id='hero'> a Web Developer with a passion for software development. My journey has been marked by a dedication to Proficient in C,C++,Python,Javascript,Full Stack Development. With a background in BCA, I bring a unique perspective to Software Industry.</p>
                <button id='hero'
                  onClick={()=>{props.create()}}
                  className="relative text-[#041F31] font-medium py-3 px-6 rounded-md hover:opacity-80 bg-gradient-to-r from-[rgb(0,245,160)] to-[rgb(0,217,245)] "
                >
                  Contact
                </button>
              </div>
